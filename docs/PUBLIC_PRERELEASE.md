...
OBD Atlas 0.1.0 Alpha 4 is an early research release. Download the file matching the host from the GitHub Releases page.
...
Extract `OBD-Atlas-Linux-arm64-v0.1.0-alpha.4.zip`, then run:
